...
type SharedInformerFactory interface {
	...
	Pipelinesfeedback() pipelinesfeedbackkeskadpl.Interface
}

func (f *sharedInformerFactory) Pipelinesfeedback() pipelinesfeedbackkeskadpl.Interface {
	return pipelinesfeedbackkeskadpl.New(f, f.namespace, f.tweakListOptions)
}
